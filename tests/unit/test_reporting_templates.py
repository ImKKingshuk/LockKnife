...
def test_render_bundled_templates() -> None:
    ...
    context = {
        ...
        "case_summary": {"total_artifact_count": 1, "artifact_count": 1, "jobs": {"total": 0}, "runtime_sessions": {"total": 0}, "artifacts_by_category": {"extract-sms": 1}},
        "integrity": {"summary": {"verified_count": 1, "modified_count": 0, "missing_count": 0, "unreadable_count": 0, "unsupported_count": 0}, "advisory": "ok"},
        "evidence_inventory": [{"artifact_id": "artifact-0001", "category": "extract-sms", "status": "verified", "path": "evidence/sms.json"}],
        "evidence_summary": {"artifact_count": 1, "artifact_payload_rows": 1, "top_categories": [{"name": "extract-sms", "count": 1}]},
        "report_sections": [{"title": "PDF readiness", "summary": "PDF backend unavailable; HTML fallback may be required.", "status": "medium", "details": ["wkhtmltopdf missing"]}],
...
def test_render_chain_of_custody_template() -> None:
    ...
    html = render_html_report(
        base / "chain_of_custody.html",
        {
            ...
            "entries": [{"name": "sms", "path": "/tmp/sms.json", "sha256": "b" * 64, "previous_hash": "0" * 64, "entry_hash": "c" * 64}],
        },
    )
