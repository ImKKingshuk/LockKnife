...
_DANGEROUS: dict[str, PermissionRisk] = {
    ...
    "android.permission.READ_CONTACTS": PermissionRisk(
        "android.permission.READ_CONTACTS", "high", 9
    ),
    "android.permission.WRITE_CONTACTS": PermissionRisk(
        "android.permission.WRITE_CONTACTS", "high", 9
    ),
    ...
    "android.permission.ACCESS_FINE_LOCATION": PermissionRisk(
        "android.permission.ACCESS_FINE_LOCATION", "high", 9
    ),
    "android.permission.ACCESS_COARSE_LOCATION": PermissionRisk(
        "android.permission.ACCESS_COARSE_LOCATION", "medium", 7
    ),
    "android.permission.READ_CALL_LOG": PermissionRisk(
        "android.permission.READ_CALL_LOG", "high", 9
    ),
    "android.permission.WRITE_CALL_LOG": PermissionRisk(
        "android.permission.WRITE_CALL_LOG", "high", 9
    ),
    "android.permission.READ_EXTERNAL_STORAGE": PermissionRisk(
        "android.permission.READ_EXTERNAL_STORAGE", "medium", 6
    ),
    "android.permission.WRITE_EXTERNAL_STORAGE": PermissionRisk(
        "android.permission.WRITE_EXTERNAL_STORAGE", "medium", 6
    ),
}
